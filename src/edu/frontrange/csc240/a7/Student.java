 ...
 * @version		2.0, 2019-03-15, CSC-240 Assignment 7
 */
 ...
 * @throws StudentException if Student instance cannot be constructed
 */
public Student(String studentID, String firstName, String lastName) throws StudentException
{
	/* Initialize with the provided values. There is no need to preset values
	   before the validation, since, if any validation fails, the constructor
	   will terminate with an exception, and the caller will have no access to the
	   object. */
	try
	{
	...
	{
		throw new StudentException("Construction error: ", ex);
	}
}
...
public Student(String studentID, String firstName, String lastName,
									FRCCDate birthDate) throws StudentException
{
 ...
 */
public Student(String studentID, String firstName, String lastName,
					FRCCDate birthDate,	Degree targetDegree) throws StudentException
{
...
public final void setBirthDate(FRCCDate birthDate)
{
	...
	assert birthDate != null : "birthDate must not be null";
...
{
	/* Assert the precondition. */
	assert targetDegree != null : "targetDegree must not be null";
 ...
 * @throws ValidationException if student first name is invalid
 */
 ...
 * @throws ValidationException if student last name is invalid
 */
...
private static boolean isValidFirstName(String name) throws ValidationException
{
	...
	throw new ValidationException("Invalid first name: " + name);
}
												...
												throws ValidationException
{
	...
	/* If no valid studentID was discovered, report it. */
